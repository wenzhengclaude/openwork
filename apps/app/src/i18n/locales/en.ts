...
export default {
  ...
  "app.plugins_hint_readonly": "Open One server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "Open One server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "connect.connected_to_cloud": "Connected to Open One Cloud",
  ...
  "connect.header_description": "Use team-approved cloud connections shared from Open One Den.",
  ...
  "connect.pitch_title": "Connect is the new way Open One lets you share workflows with your team.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected Open One servers.",
  ...
  "config.server_needed_hint": "Open One server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an Open One server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "Open One server",
  ...
  "config.server_sharing_title": "Open One server sharing",
  "config.server_url_hint": "Use the URL shared by your Open One server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "Open One server URL",
  "config.server_url_label": "Open One Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable Open One server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "Open One server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "Open One server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "Open One server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable Open One server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted Open One worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted Open One worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an Open One server as a workspace.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the Open One server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted Open One worker.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and Open One will reconnect here automatically.",
  ...
  "den.cloud_section_desc": "Sign in and pick an organization to access Open One Cloud.",
  "den.cloud_section_title": "Open One Cloud",
  "den.cloud_sleep_hint": "Sign in to Open One Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use Open One Cloud.",
  "den.cloud_unavailable_body": "Local work remains available. Reconnecting automatically.",
  "den.cloud_unavailable_title": "Open One Cloud is temporarily unavailable.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but Open One Cloud did not return a session token.",
  "den.error_paste_valid_code": "Paste a valid Open One sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete Open One Cloud sign-in.",
  "den.error_signout_failed": "Could not sign out of Open One Cloud. Try again.",
  ...
  "den.org_onboarding_ai_providers_desc": "Models you can use in your workspace.",
  "den.org_onboarding_ai_providers_title": "AI Providers",
  "den.org_onboarding_choose_title": "Choose your organization",
  "den.org_onboarding_claim_workspace": "Claim this workspace to add billing & teammates",
  "den.org_onboarding_connecting": "Connecting...",
  "den.org_onboarding_connected": "Connected",
  "den.org_onboarding_continue_org": "Continue with organization",
  "den.org_onboarding_continue_workspace": "Continue to workspace",
  "den.org_onboarding_default_badge": "Default",
  "den.org_onboarding_default_model_set": "{model} will be set as your default model.",
  "den.org_onboarding_empty_resources_desc": "Add AI providers or marketplaces from the Open One Cloud dashboard.",
  "den.org_onboarding_empty_resources_title": "No resources have been configured for this organization yet.",
  "den.org_onboarding_first_skill_ready": "First skill ready:",
  "den.org_onboarding_footer_hint": "Providers are added to your workspace automatically. Marketplaces are available from Cloud settings.",
  "den.org_onboarding_load_error": "Unable to load organizations.",
  "den.org_onboarding_loading_orgs": "Loading organizations...",
  "den.org_onboarding_loading_resources": "Loading available resources...",
  "den.org_onboarding_marketplace_count_one": "1 marketplace",
  "den.org_onboarding_marketplace_count_other": "{value} marketplaces",
  "den.org_onboarding_marketplaces_desc": "App stores with extensions and plugins for your workspace.",
  ...
  "den.org_onboarding_more_models": "+{value} more",
  "den.org_onboarding_no_matches": "No organizations match your search.",
  "den.org_onboarding_no_orgs_found": "No organizations found.",
  "den.org_onboarding_open_cloud": "Open One Cloud",
  "den.org_onboarding_open_workspace": "Open your workspace and try a task",
  "den.org_onboarding_organizations_label": "Organizations",
  "den.org_onboarding_plugin_count_one": "1 plugin",
  "den.org_onboarding_plugin_count_other": "{value} plugins",
  "den.org_onboarding_prepared_desc": "Your workspace and first skill are set up. Try a task to see Open One work for you - no further setup needed.",
  "den.org_onboarding_resources_desc": "You have access to the following resources.",
  "den.org_onboarding_role_member": "Member",
  "den.org_onboarding_role_owner": "Owner",
  "den.org_onboarding_search_label": "Search organizations",
  "den.org_onboarding_search_placeholder": "Search organizations...",
  "den.org_onboarding_select_desc": "Select the organization whose cloud resources should be connected to this workspace.",
  "den.org_onboarding_select_error": "Unable to select organization.",
  "den.org_onboarding_select_org_label": "Select an organization",
  "den.org_onboarding_select_org_settings_desc": "Choose the organization to use with this workspace. Sign out to switch later.",
  "den.org_onboarding_setup_complete_prepared": "Setup complete - Open One prepared this workspace",
  "den.org_onboarding_setup_complete_ready": "Setup complete - Open One is ready",
  "den.org_onboarding_show_more": "Show more",
  "den.org_onboarding_showing_count": "Showing {visible} of {total} organizations",
  "den.org_onboarding_task_idea_downloads": "Summarize the files in my Downloads folder.",
  "den.org_onboarding_task_idea_intro_email": "Draft a short intro email about Open One I can send my team.",
  "den.org_onboarding_task_idea_screenshots": "Create a CSV of my last 10 screenshots with their dates.",
  "den.org_onboarding_try_asking": "Try asking",
  "den.org_onboarding_use_as_default": "Use as default",
  "den.org_onboarding_your_org_title": "Your organization",
  "den.org_onboarding_your_workspace": "Your workspace",
  "den.open": "Open",
  "den.opening": "Opening...",
  ...
  "den.signin_code_note": "Accepts an openone://den-auth link or the raw one-time grant.",
  "den.signin_link_copied": "Copied",
  "den.signin_link_hint": "If your browser doesn't bounce back into Open One automatically, paste the sign-in link or one-time code from Open One Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openone://den-auth?... or pasted code",
  "den.signin_title": "Sign in to Open One Cloud",
  "den.signing_in": "Finishing Open One Cloud sign-in...",
  "den.signing_out": "Signing out...",
  "den.status_base_url_updated": "Updated the Cloud control plane URL. Sign in again to continue.",
  "den.status_browser_signin": "Finish signing in in your browser to connect Open One.",
  "den.status_browser_signup": "Finish account creation in your browser to connect Open One.",
  "den.status_cloud_signed_in_as": "Connected Open One Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected Open One Cloud.",
  ...
  "den.status_signed_out": "Signed out and cleared your Open One Cloud session on this device.",
  "den.status_server_config_cleared": "Cleared the desktop server configuration. Open One is using the default Cloud control plane.",
  "den.sync": "Sync",
  ...
  "extensions.marketplace_description": "Browse built-in Open One extensions and organization marketplace extensions. Claude-compatible plugins are normalized into Open One extensions with installable resources such as skills, MCPs, commands, or tools.",
  ...
  "mcp.toggle_requires_server": "Connect to an Open One server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so Open One can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, Open One needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, Open One needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize Open One",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from Open One.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "Open One Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the Open One app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "Open One UI Control",
  ...
  "notifications.empty_hint": "Updates from Open One Cloud and your workspaces will show up here.",
  "notifications.engine_reloaded": "Updates applied",
  "notifications.just_now": "Just now",
  "notifications.reconnect_failed": "Couldn't reconnect to the Open One server",
  ...
  "welcome.title": "Welcome to Open One",
  ...
  "welcome.organization_server_dialog_desc": "Paste the server URL your IT team shared. Open One will use it before sign-in and cloud features.",
  "welcome.organization_server_dialog_title": "Connect to your organization's server",
  "welcome.organization_server_error": "Enter a valid http:// or https:// Open One server URL.",
  "welcome.organization_server_link": "Using Open One on-premises?",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. Open One will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and Open One can pick them up.",
  "plugins.add": "Add",
  ...
  "session.archive_task": "Archive task",
  "session.clipboard_unavailable": "System clipboard is unavailable.",
  "session.continue_in": "Continue in...",
  "session.copy_failed": "Copy failed",
  "session.copy_menu": "Copy",
  "session.copy_success": "{label} copied",
  "session.copy_task_id": "Copy task ID",
  "session.copy_task_link": "Copy task link",
  "session.copy_task_title": "Copy task title",
  "session.copy_task_transcript": "Copy task transcript",
  "session.copy_transcript_empty": "This task has no copyable content yet.",
  "session.copy_transcript_failed": "Could not copy task transcript",
  "session.copy_transcript_read_unavailable": "Could not read the current task transcript.",
  ...
  "session.open": "Open",
  "session.open_side_task": "Open side task",
  "session.open_side_task_failed": "Could not create side task",
  "session.open_task_new_window": "Open in new window",
  ...
  "session.rename_task": "Rename task",
  "session.rename_title": "Rename session",
  "session.resize_workspace_column": "Resize workspace column",
  "session.revert_label": "Revert",
  "session.run_mode_codex_desc": "Continue with Codex-native subagents.",
  "session.run_mode_codex_label": "Codex",
  "session.run_mode_fallback": "run mode",
  "session.run_mode_grok_build_desc": "Continue with Grok Build-native subagents.",
  "session.run_mode_grok_build_label": "Grok Build",
  "session.run_mode_multi_agent_desc": "Run Codex and Grok Build in parallel.",
  "session.run_mode_multi_agent_label": "Multi-agent",
  "session.run_mode_opencode_desc": "Use the standard Open One workflow.",
  "session.run_mode_opencode_label": "Default mode",
  ...
  "session.share_local_host_not_ready": "Local Open One host is not ready yet.",
  "session.share_missing_host_url": "Missing Open One host URL.",
  "session.share_missing_token": "Missing Open One token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for Open One workers.",
  ...
  "session.side_task_opened": "Side task opened",
  ...
  "settings.privacy_section_desc": "Control what Open One shares to improve the product.",
  ...
  "settings.capabilities_title": "Open One server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point Open One at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "Open One server: {version}",
  ...
  "settings.deeplink_hint": "Accepts openone:// or openone-dev:// links.",
  ...
  "settings.desktop_notifications.mode_desc": "Choose which Open One events can appear as native operating system notifications.",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by Open One. Off by default.",
  ...
  "settings.feedback_title": "Help shape Open One",
  ...
  "settings.open_deeplink_desc": "Paste an Open One deeplink or share URL to open it.",
  ...
  "settings.organization_server_default": "Using standard Open One Cloud.",
  "settings.organization_server_desc": "Point Open One at the server your organization hosts. This is available without developer mode.",
  "settings.organization_server_title": "Organization server",
  "settings.organization_server_url_hint": "Paste your organization's Open One server URL. Saving signs you out so Open One can re-hydrate against that server.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by Open One.",
  ...
  "settings.openwork_config_sidecar_desc": "Local Open One server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "Open One server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "Open One server",
  ...
  "settings.quit_hint": "Open One quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect Open One server.",
  "settings.reconnected": "Reconnected to Open One server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears Open One cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears Open One cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. Open One will restart.",
  ...
  "settings.reset_onboarding_description": "Clears Open One preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears Open One local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset Open One + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but Open One will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openwork_server": "Restart Open One server",
  ...
  "settings.services_section_desc": "Local services that power this Open One session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting Open One.",
  ...
  "settings.server_endpoints_desc": "Read-only view of the URLs Open One will use after local overrides and bootstrap files are applied.",
  ...
  "settings.runtime_desc": "Status for your local engine and Open One server.",
  ...
  "settings.tab_description_appearance": "Adjust how Open One looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected Open One workspace plus its runtime connection.",
  "settings.tab_description_shell": "Branding, visibility, and shell controls",
  "settings.shell.app_name_desc": "Appears in the title bar, sidebar, and welcome screen.",
  "settings.shell.app_name_label": "App name",
  "settings.shell.app_name_managed": "This application name is managed by your organization.",
  "settings.shell.app_name_title": "Application name",
  "settings.shell.app_name_unset": "Your organization has not set a custom application name.",
  "settings.shell.branding_desc": "Customize the name your users see across the app.",
  "settings.shell.branding_title": "Branding",
  "settings.shell.customized_status": "Some settings have been customized.",
  "settings.shell.defaults_status": "All settings are at their defaults.",
  "settings.shell.display_add_workspace_desc": "Let users create or join additional workspaces.",
  "settings.shell.display_add_workspace_label": "Display new workspace button",
  "settings.shell.display_add_workspace_unavailable": "The new workspace button display control is not available yet.",
  "settings.shell.display_browser_desc": "A built-in browser for viewing web content alongside sessions.",
  "settings.shell.display_browser_label": "Display browser panel",
  "settings.shell.display_browser_unavailable": "The browser panel display control is not available yet.",
  "settings.shell.display_docs_desc": "Show a link to your documentation.",
  "settings.shell.display_docs_label": "Display documentation link",
  "settings.shell.display_feedback_desc": "Show a button for submitting feedback.",
  "settings.shell.display_feedback_label": "Display feedback button",
  "settings.shell.display_menu_bar_desc": "Show the native desktop menu bar.",
  "settings.shell.display_menu_bar_label": "Display menu bar",
  "settings.shell.display_model_picker_desc": "Let users choose which AI model to use.",
  "settings.shell.display_model_picker_label": "Display model picker",
  "settings.shell.display_model_picker_unavailable": "The model picker display control is not available yet.",
  "settings.shell.display_notifications_desc": "A header entry for organization and workspace updates.",
  "settings.shell.display_notifications_label": "Display notifications",
  "settings.shell.display_sidebar_desc": "Browse workspaces and past sessions from a side panel.",
  "settings.shell.display_sidebar_label": "Display sidebar",
  "settings.shell.display_signin_desc": "Show a sign-in prompt for users who are not logged in.",
  "settings.shell.display_signin_label": "Display sign-in prompt",
  "settings.shell.display_status_bar_desc": "Quick access to status, settings, and actions along the bottom edge.",
  "settings.shell.display_status_bar_label": "Display status bar",
  "settings.shell.display_task_suggestions_desc": "Show task suggestions to help users get started.",
  "settings.shell.display_task_suggestions_label": "Display task suggestions",
  "settings.shell.enable_welcome_desc": "A getting-started screen for first-time users.",
  "settings.shell.enable_welcome_label": "Enable welcome page",
  "settings.shell.extension_restrictions_desc": "Limit which extensions, plugins, and skills users can install.",
  "settings.shell.extension_restrictions_label": "Extension restrictions",
  "settings.shell.hidden_entries_hint": "Anything you hide is still available via the command palette ({shortcut}).",
  "settings.shell.layout_desc": "Customize what is visible in the interface.",
  "settings.shell.layout_title": "Layout",
  "settings.shell.model_restrictions_desc": "Limit which AI models and providers users can choose from.",
  "settings.shell.model_restrictions_label": "Model restrictions",
  "settings.shell.organization_admin_only": "These settings can only be changed by your organization admin. Contact your admin to make changes.",
  "settings.shell.organization_desc": "These settings are managed by your organization in the Open One console.",
  "settings.shell.organization_managed_badge": "Organization managed",
  "settings.shell.organization_title": "Organization-wide settings",
  "settings.shell.reset_defaults": "Reset to defaults",
  "settings.shell.settings_access_desc": "Let users open the settings panel.",
  "settings.shell.settings_access_label": "Settings access",
  "settings.shell.status_bar_hidden_warning": "When hidden, the only way to access settings is via {shortcut}.",
  "settings.shell.wireframe.add_workspace": "Add workspace",
  "settings.shell.wireframe.browse_web": "Browse web",
  "settings.shell.wireframe.composer_placeholder": "Describe your task...",
  "settings.shell.wireframe.contract_review": "Contract review",
  "settings.shell.wireframe.docs": "Docs",
  "settings.shell.wireframe.edit_csv": "Edit a CSV",
  "settings.shell.wireframe.extensions": "Extensions",
  "settings.shell.wireframe.feedback": "Feedback",
  "settings.shell.wireframe.meeting_brief": "Meeting brief",
  "settings.shell.wireframe.new_session": "+ New session",
  "settings.shell.wireframe.outreach_crm": "Outreach CRM",
  "settings.shell.wireframe.ready": "Ready",
  "settings.shell.wireframe.run": "Run",
  "settings.shell.wireframe.sign_in": "Sign in",
  ...
  "memory.sign_in_hint": "Sign in to your Open One account to view your memory bank.",
  ...
  "settings.update_restart_active_tasks": "You have active tasks. Installing the update restarts Open One and will interrupt them.",
  "settings.update_restart_confirm_title": "Restart with active tasks?",
  "settings.update_restart_confirm_message": "Installing the update restarts Open One now and interrupts your active tasks. You may need to resume them after the update.",
  "settings.update_uptodate": "You're up to date",
  "settings.updates": "Updates",
  "settings.updates_desc": "Keep Open One up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an Open One host, then choose it from the list to import this skill.",
  ...
  "skills.add_openwork_hub": "Add Open One Hub",
  ...
  "skills.cloud_section_subtitle": "Skills shared with you through Open One Cloud.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to Open One Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected Open One server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active Open One Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active Open One Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "Open One Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full Open One features",
  ...
  "status.openwork_ready": "Open One Ready",
  ...
  "system.reload_body_default": "Open One detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "Open One detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "Open One can't load tasks from this worker until the connection is fixed.",
  ...
  "settings.tab_description_general_short": "Overview of all settings",
  ...
  "settings.runtime_client_connected_detail": "Chat and task creation can use the OpenCode engine for this workspace.",
  "settings.runtime_client_disconnected_detail": "Chat and task creation may fail until OpenCode restarts.",
  "settings.runtime_client_disconnected_sources_detail": "Open One server config sources below can still be inspected.",
  "settings.runtime_server_connected_detail": "Runtime DB, workspace config, and migration diagnostics are available.",
  "settings.runtime_server_disconnected_detail": "Runtime config diagnostics need the Open One server connection.",
  "settings.runtime_config_status_load_failed": "Failed to load runtime config status.",
  "settings.runtime_config_migrated_status": "Migrated legacy runtime config: {keys}.",
  "settings.runtime_config_no_legacy_status": "No legacy runtime config found for this workspace.",
  "settings.runtime_config_migrate_failed": "Failed to migrate legacy runtime config.",
  "settings.runtime_config_none": "none",
  "settings.runtime_config_not_set": "not set",
  "settings.runtime_config_default_agent": "Default agent",
  "settings.runtime_config_agent": "Agent",
  "settings.runtime_config_providers_models": "Providers / models",
  "settings.runtime_config_providers_models_value": "{providers} providers, {models} models",
  ...
  "settings.runtime_config_mcp_permissions": "MCP / permissions",
  "settings.runtime_config_mcp_permissions_value": "{mcps} MCPs, {permissions} permission keys",
  "settings.runtime_config_disabled_providers": "Disabled providers",
  "settings.runtime_config_found": "Found",
  "settings.runtime_config_not_found": "Not found",
  "settings.runtime_config_key_count": "{count} keys",
  "settings.runtime_config_keys": "Keys: {keys}",
  "settings.runtime_config_show_raw_json": "Show raw JSON",
  "settings.runtime_config_sources_title": "OpenCode config sources",
  "settings.runtime_config_sources_desc": "Inspect what Open One controls at runtime versus what belongs to your workspace config. This works through the Open One server and does not require the OpenCode engine to be healthy.",
  "settings.runtime_config_move_title": "Move Open One-managed config",
  "settings.runtime_config_move_desc": "Moves older Open One-owned runtime keys from `.opencode/openwork.json` and safe Open One-managed keys from `opencode.jsonc` into the runtime database.",
  "settings.runtime_config_refresh": "Refresh",
  "settings.runtime_config_migrate": "Migrate",
  "settings.runtime_config_migrating": "Migrating...",
  "settings.runtime_config_effective_title": "Effective injected OpenCode config",
  "settings.runtime_config_effective_desc": "This is the Open One-built config object injected through the server-managed `OPENCODE_CONFIG` file. It includes Open One defaults plus runtime DB values and is rewritten on every runtime config change.",
  "settings.runtime_config_runtime_source": "Runtime source",
  "settings.runtime_config_show_raw_injected_json": "Show raw injected JSON",
  "settings.runtime_config_source_breakdown_title": "OpenCode source breakdown",
  "settings.runtime_config_source_breakdown_desc": "OpenCode also reads its own project and global config files. Open One injects the runtime config separately; for Open One-managed keys, the injected config is the source to inspect.",
  "settings.runtime_config_project_title": "Project opencode config",
  "settings.runtime_config_project_desc": "Workspace-level OpenCode config owned by the user/project.",
  "settings.runtime_config_global_title": "Global opencode config",
  "settings.runtime_config_global_desc": "User-level OpenCode config under ~/.config/opencode.",
  "settings.runtime_config_runtime_db_title": "Open One runtime DB",
  "settings.runtime_config_runtime_db_desc": "Open One-managed runtime values stored outside workspace files.",
  "settings.runtime_config_injected_title": "Open One injected config",
  "settings.runtime_config_injected_desc": "The object Open One injects into OpenCode at runtime.",
  "settings.runtime_config_runtime_database": "Runtime database",
  "settings.runtime_config_stored_keys": "Stored keys: {keys}",
  "settings.runtime_config_legacy_metadata": "Legacy Open One metadata",
  "settings.runtime_config_legacy_error_hint": "{error}; fix this file before moving legacy config.",
  "settings.runtime_config_migratable_keys": "Migratable keys: {keys}",
  "settings.runtime_config_user_opencode": "User opencode.jsonc",
  "settings.runtime_config_user_owned_keys": "User-owned keys: {keys}",
  "settings.runtime_config_runtime_db_json": "Runtime DB JSON",
