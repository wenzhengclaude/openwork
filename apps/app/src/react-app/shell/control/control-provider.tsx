...
export function OpenworkRouteControlActions() {
  ...
  const actions = useMemo<OpenworkControlAction[]>(() => [
    ...
    },
    {
      ...
      label: "What can Open One do?",
      description: "List the main capabilities of Open One.",
      sideEffect: "none",
      execute: () => ({
        capabilities: [
          ...
          { id: "voice", label: "Voice mode", description: "Talk to Open One with real-time voice using OpenAI Realtime." },
          ...
          { id: "sharing", label: "Share sessions", description: "Share workspace sessions with collaborators via Open One Cloud." },
        ],
