...
const SUPPORT_MAILTO = `mailto:${SUPPORT_EMAIL}?subject=Open%20One%20Den%20remote%20worker%20upgrade`;

/**
 * Small inline link rendered inside the remote-worker error card. When clicked,
 * it opens a dialog explaining the Open One Den upgrade situation and how to
 * reach support.
 */
