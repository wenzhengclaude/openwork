...
export const BUILT_IN_OPENWORK_EXTENSION_MANIFESTS: OpenWorkExtensionManifest[] = [
  ...
  },
  {
    ...
    setup: {
      instructions: "Add an OpenAI API key, then agents can generate image artifacts through Open One extension actions.",
  ...
  },
  {
    ...
    description: "Let Open One help with meetings, selected Drive files, and Gmail drafts.",
    preview: true,
    source: { format: "openwork-builtin", origin: "builtin", trusted: true },
    icon: { simpleIconSlug: "google" },
    composer: { prompt: "Use Google Workspace to " },
    setup: {
      instructions: "Connect your Google account to use Calendar, Drive, and Gmail drafts in Open One.",
